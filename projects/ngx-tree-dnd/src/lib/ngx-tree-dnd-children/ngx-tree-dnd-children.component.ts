...
import {TreeConfig, TreeItemOptions, TreeModel} from '../models/tree-view.model';
...
export class NgxTreeChildrenComponent implements AfterViewInit {
    ...
    */
    submitAdd(name, item) {
        ...
        const icon = '';
        this.treeService.addNewItem(elemId, name, icon, true, item);
    ...
    */
    submitRename(item) {
        if (this.renameForm.valid) {
            ...
            this.treeService.finishRenameItem(this.renameForm.value.name, item.id, '', true);
